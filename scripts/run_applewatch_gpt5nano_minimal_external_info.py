#!/usr/bin/env python3
"""Run the 80-row Apple Watch gpt-5-nano minimal experiment with external information."""
...
BASELINE_CSV = (
    APPLEWATCH_DIR
    / "baseline_prediction"
    / "AppleWatch_gpt5nano_minimal_temp1_10variants.csv"
)
EXTERNAL_INFO_FILES = (
...
OUTPUT_CSV = (
    ...
    / "ek_applewatch_gpt5nano_t1_minimal.csv"
)
