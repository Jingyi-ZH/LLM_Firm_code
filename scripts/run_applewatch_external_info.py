#!/usr/bin/env python3
"""Run the 80-row Apple Watch gpt-4.1 experiment with external information."""
...
BASELINE_CSV = (
    APPLEWATCH_DIR
    / "baseline_prediction"
    / "AppleWatch_gpt41_temp1_10variants.csv"
)
EXTERNAL_INFO_FILES = (
...
OUTPUT_CSV = (
    ...
    / "ek_AppleWatch_gpt41_temp1_10variants.csv"
)
...
def build_prompt(baseline_prompt_json: str, external_message: dict[str, str]) -> list[dict[str, str]]:
    ...
    with IN_PROGRESS_CSV.open("a", newline="", encoding="utf-8") as file:
        ...
        for index, row in enumerate(pending, start=1):
            ...
            print(
                ...
                f"variant={row['prompt_variant']} label={label or 'INVALID'} "
